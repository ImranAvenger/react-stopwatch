  ...
  return (
    <div className="flex items-center justify-center gap-6 landscape:gap-4">
      <button
        onClick={onReset}
        disabled={!canReset}
        className={`w-16 h-16 rounded-full text-white text-2xl flex items-center justify-center transition-all active:scale-95 hover:shadow-lg enabled:cursor-pointer ${
          isDarkMode
            ? "bg-rose-500 hover:bg-rose-600 disabled:bg-slate-700 disabled:text-slate-500 hover:shadow-rose-500/50"
            : "bg-rose-500 hover:bg-rose-600 disabled:bg-slate-300 disabled:text-slate-400 hover:shadow-rose-500/50"
        }`}
        title="Reset (R)"
      ...
      <button
        ...
        className={`w-16 h-16 rounded-full text-white text-2xl flex items-center justify-center transition-all active:scale-95 hover:shadow-lg enabled:cursor-pointer ${
          isDarkMode
            ? "bg-sky-500 hover:bg-sky-600 disabled:bg-slate-700 disabled:text-slate-500 hover:shadow-sky-500/50"
            : "bg-sky-500 hover:bg-sky-600 disabled:bg-slate-300 disabled:text-slate-400 hover:shadow-sky-500/50"
        }`}
        title="Record Lap (L)"
